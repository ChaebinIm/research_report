...
> ⚠️ 오해 주의: 굿윌(goodwill)은 **회사 이름이 아니라 회계 계정 이름**(한국어로 '영업권')이다. 비유 — 권리금 3억을 주고 장부상 설비 1억짜리 가게를 4억에 샀을 때, 차액 3억(단골·목·간판값)을 장부에 '영업권'으로 적는 것. 서비스나우의 굿윌 98.4억 달러는 무브웍스 등 **역대 인수 대상들에 지불한 웃돈의 누적 합계**다.
...
### 5.4 비용구조 해부 — 이 회사는 돈을 어디에 쓰나 (2Q26 손익계산서)

![비용구조](../img_서비스나우/04_비용구조.png)

제조업(재료비·감가상각 중심)과 완전히 다르다 — **비용의 대부분이 '사람'과 '컴퓨팅'**이다. 2Q26 매출 39.9억 달러 기준:

| 비용 항목 | 금액 (매출 대비) | 안에 뭐가 들었나 |
|---|---|---|
| **매출원가** | ~11.7억 달러 (29.3%) | ① **데이터센터·클라우드 인프라** — 서비스나우는 자체 데이터센터를 직접 운영하는 드문 SaaS(+하이퍼스케일러 병행)라 서버·전력·감가상각이 여기 잡힌다 ② **AI 추론 컴퓨팅**(GPU) — 최근 가장 빨리 크는 신입 비용, '마진 AI 압박'의 진원지 ③ 고객 기술지원 인력 ④ 프로페셔널 서비스(컨설팅) 인건비 — 매출 1.1억 달러짜리 저마진 사업의 원가 ⑤ 인수 무형자산 상각 일부 |
| **영업·마케팅 (최대 비용)** | 13.7억 달러 (**34.4%**) | 대기업 **직판 영업부대** — 계정마다 영업대표+솔루션 엔지니어가 붙는 고비용 모델, 영업 커미션(계약 기간에 나눠 상각), Knowledge 등 대형 행사·광고. 매출의 3분의 1을 파는 데 쓴다 — 엔터프라이즈 SaaS의 숙명 |
| **연구개발** | 9.2억 달러 (23.0%) | Now Platform·AI(Now Assist, 에이전트) 개발 인력 — 사실상 엔지니어 인건비. 무브웍스 인력도 여기 합류 |
| **관리비(G&A)** | 3.7억 달러 (9.3%) | 경영·재무·법무·인사 등 본사 기능 |
| **(횡단) 주식보상 SBC** | **6.6억 달러 (16.4%)** | 별도 줄이 아니라 **위 네 항목 전부에 스며들어 있는** 인건비의 주식 지급분 — 원가에도, R&D에도, S&M에도 배분돼 있다. 비GAAP은 이걸 다시 빼서 계산 |
| = GAAP 영업이익 | 1.62억 달러 (4.1%) | 비GAAP로는 11.7억 달러 (29.5%) |

**구조에서 읽어야 할 것 4가지**:

1. **최대 비용은 기술이 아니라 '파는 비용'(34.4%)** — 엔터프라이즈 직판 모델의 특성이다. 긍정적 면: 갱신·업셀 위주라 영업 효율이 신규 개척형보다 높고, 매출이 커질수록 이 비율은 완만히 내려와 왔다(영업 레버리지). 이 비율의 하락 속도가 장기 마진 개선의 제1 동력
2. **원가율 29.3%의 방향이 AI 논쟁의 격전지** — 전통 SaaS 원가율은 20% 안팎까지 낮아지는 게 보통인데, AI 추론 비용이 이걸 거꾸로 밀어올리는 중이다. "AI 매출이 늘수록 원가도 는다"가 소프트웨어의 새 현실 — 매출총이익률(현재 71%)이 몇 분기 연속 하락하면 경보
3. **비용의 성격: 반고정** — 재료비형(매출 비례) 비용이 거의 없어, 매출이 늘면 이익이 급격히 붙는 영업 레버리지 구조다. 거꾸로 성장이 꺾이면 비용은 바로 못 줄여서(인력 중심) 이익이 급격히 상한다 — 성장률에 밸류가 민감한 근본 이유
4. **SBC 16.4%가 숨은 제5의 비용** — 손익계산서에 별도 줄로 안 보이고 각 항목에 분산돼 있어 놓치기 쉽다. §5.0에서 본 대로 회사가 2029년까지 10% 미만으로 낮추겠다고 공약한 그 항목 — 이 비율이 내려가면 같은 매출에서 GAAP 이익이 자동으로 두꺼워진다
